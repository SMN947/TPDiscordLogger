    ...
    def gearBot_Clean(txt):
        ...
        if(action == "<:gearBan:585878361491111946>"):
            ...
            if "was banned by" in split1[1]:
                ...
                content["actionTarget"] = test[0]+"www"
...
def cleanContent(cnt):
    cnt['actionTarget'] = (cnt['actionTarget'].split(" (`"))[0]
    cnt['actionAuthor'] = (cnt['actionAuthor'].split(" (`"))[0]
    cnt['actionAction'] = cnt['actionAction'].split(":")[1]
    return cnt